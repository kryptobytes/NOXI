...
const string strMessageMagic = "NOXI Signed Message:\n";
...
static const int64 nTargetTimespan = 86400; // NOXI: 1 days
static const int64 nTargetSpacing = 360; // NOXI: 360 second blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal NOXI miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "NOXI", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = " - Coin generated through Kryptobytes 15:40:18-07/10/14";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
